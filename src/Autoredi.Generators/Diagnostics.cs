...
public static class Diagnostics
{
    ...
    public static readonly DiagnosticDescriptor InvalidAttributeArgumentsDescriptor = new(
        ...
        messageFormat: "The AutorediAttribute on class '{0}' has an invalid number of arguments. Expected: lifetime, interfaceType, serviceKey, group, priority.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor InvalidGroupNameDescriptor = new(
        ...
        messageFormat: "The group name '{0}' contains invalid characters. Group names must be valid C# identifiers (letters, digits, underscore) and cannot be reserved keywords.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static readonly DiagnosticDescriptor PriorityOutOfRangeDescriptor = new(
        ...
        messageFormat: "The priority value {1} for class '{0}' is out of range. Priority must be between 0 and 999 (inclusive).",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
