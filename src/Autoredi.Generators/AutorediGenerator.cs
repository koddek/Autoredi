...
public sealed class AutorediGenerator : IIncrementalGenerator
{
        ...
        SourceProductionContext context)
    {
        ...
        var referencedAutorediNamespaces = GetReferencedAutorediNamespaces(compilation, projectName, attributeType, visitedAssemblies, context);
    ...
    private static bool HasAutorediAttributeOrNamespace(Compilation compilation, IAssemblySymbol assembly, INamedTypeSymbol attributeType)
    {
