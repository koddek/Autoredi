...
{
    public static string Generate(ImmutableArray<ServiceRegistration> registrations, string @namespace)
    {
        ...
        builder.Block(b =>
        {
            ...
            GenerateDefaultGroupExtensionMethod(b, registrations);
        });
    ...
    private static void GenerateDefaultGroupExtensionMethod(SourceBuilder builder, ImmutableArray<ServiceRegistration> registrations)
    {
        builder.Method("public static", "IServiceCollection", "AddAutorediServicesDefault", "this IServiceCollection services");
        builder.Block(b =>
        {
